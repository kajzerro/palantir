...
| **Prawy górny – cyfrowy bliźniak** | Model 3D kopalni w rzucie z lotu ptaka: powierzchnia, poziom −300 m i poziom −500 m ułożone jeden pod drugim (widok rozstrzelony), szyby, ściany, przekopy, pochylnia taśmowa, komora MW, wentylator… Każdy punkt to kamera CCTV. Kliknięcie otwiera ją na podglądzie. Punkty **pulsują na czerwono** przy anomalii, są **pomarańczowe** w trakcie procedury, **szare** gdy offline. Panel boczny pozwala wyróżnić jeden poziom. |
